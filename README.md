...
```html
<script type="module">
	import * as la from '/npm/@livinglogic/livingapi@1.13.0/dist/esm-npm/livingapi.js';
	...
</script>
```
...
<script type="module">
	...
	import * as la from '/npm/@livinglogic/livingapi@1.14.0/dist/esm-npm/livingapi.js';
	...
</script>
```
